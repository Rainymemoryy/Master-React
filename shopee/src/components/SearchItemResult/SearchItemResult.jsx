    ...
    return (
        <div>
            <S.SortBar>
                ...
                <S.MiniPageControler>
                    <S.MiniPageControlerState>
                        <S.MiniPageControlerCurrentState>{pagination.page}</S.MiniPageControlerCurrentState>/
                        <S.MiniPageControlerTotalState>{pagination.page_size}</S.MiniPageControlerTotalState>
                    </S.MiniPageControlerState>

                    <S.ButtonControlerPrev onClick={goToPrev}>
                    ...
                    </S.ButtonControlerPrev>

                    <S.ButtonControlerNext onClick={goToNext}>
